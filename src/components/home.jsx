...
import profilePic from '../assets/pp.jpg'; // relative to your component
...
const Home = () => {
  return (
    <div className={styles.home}>
      ...
      <p>I’m a passionate and driven developer focused on creating meaningful digital experiences.
